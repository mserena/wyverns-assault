	...
	class _ParticleUniverseExport SpatialHashTable
	{
		public:
			...
			*/
			...
			/**	Todo.
			*/
			inline unsigned int put(const Ogre::Vector3& position, T object)
			{
			...
			*/
			...
			/**	Todo.
			*/
			inline HashTableCell& getCell(const Ogre::Vector3& position)
			{
			...
			/**	Todo.
			*/
			inline unsigned int getCellIndex(const Ogre::Vector3& position)
			{
		...
		protected:
			...
			/**	Todo.
			*/
			inline unsigned int _calculateIndex(const Ogre::Vector3& position)
			{
