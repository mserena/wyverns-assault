	...
	class _ParticleUniverseExport BaseCollider : public ParticleAffector
	{
		public:
			...
			*/
			...
			// Constants
			static const Ogre::Real DEFAULT_BOUNCYNESS;
			static const Ogre::Real DEFAULT_FRICTION;
		...
		protected:
			...
			Ogre::Real mVelocityScale; // Value set in the particle system, but stored in the collider for convenience.
	};
