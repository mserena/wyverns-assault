    ...
    */
	class _ParticleUniverseExport TextureRotator : public ParticleAffector
	{
		public:
			...
			static const Ogre::Real DEFAULT_ROTATION;
	        ...
	        */
			Ogre::Radian _calculateRotation (void);

			/** Returns a rotation speed value, depending on the type of dynamic attribute.
	        */
			Ogre::Radian _calculateRotationSpeed (Particle* particle);
		...
		protected:
			...
			Ogre::Radian mScaledRotationSpeed;
			Ogre::Radian twoPiRad;
