...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ScaleAffector : public ParticleAffector
	{
		public:
			// Constants
			static const Ogre::Real DEFAULT_X_SCALE;
			static const Ogre::Real DEFAULT_Y_SCALE;
			static const Ogre::Real DEFAULT_Z_SCALE;
			static const Ogre::Real DEFAULT_XYZ_SCALE;
