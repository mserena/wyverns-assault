...
namespace ParticleUniverse
{
	...
	protected:
		...
		Ogre::vector<ParticleRendererFactory*>::type mRendererFactories;
		Ogre::vector<ParticleEmitterFactory*>::type mEmitterFactories;
		Ogre::vector<ParticleAffectorFactory*>::type mAffectorFactories;
		Ogre::vector<ParticleObserverFactory*>::type mObserverFactories;
		Ogre::vector<ParticleEventHandlerFactory*>::type mEventHandlerFactories;
		Ogre::vector<ExternFactory*>::type mExternFactories;
		Ogre::vector<ParticleBehaviourFactory*>::type mBehaviourFactories;
	};
}
