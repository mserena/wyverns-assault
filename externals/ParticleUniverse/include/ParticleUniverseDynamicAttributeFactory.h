...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport DynamicAttributeFactory : public ScriptWriter, public Ogre::FactoryAlloc
	{
	    public:
	        ...
	        */
			...
			{
				return OGRE_NEW_T(T, Ogre::MEMCATEGORY_SCENE_OBJECTS)();
			};
	        ...
	        */
			...
			{
				OGRE_DELETE_T(dynamicAttribute, DynamicAttribute, Ogre::MEMCATEGORY_SCENE_OBJECTS);
			};
			...
			Ogre::Real _getDefaultValue(const DynamicAttribute* dynAttribute)
			{
				if (!dynAttribute)
					return 0;
