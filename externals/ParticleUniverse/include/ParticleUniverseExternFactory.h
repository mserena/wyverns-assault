...
namespace ParticleUniverse
{
    ...
    */
	class _ParticleUniverseExport ExternFactory : public ScriptReader, public ScriptWriter, public Ogre::FactoryAlloc
	{
	    protected:
	        ...
	        */
			...
			{
				Extern* externObject = OGRE_NEW T();
	...
	public:
			...
			virtual Ogre::String getExternType(void) const = 0;
