    ...
    */
	class _ParticleUniverseExport ParticleTechnique : public Particle, public IAlias, public IElement
	{
		public:
			...
			static const Ogre::Real DEFAULT_DEFAULT_WIDTH;
			static const Ogre::Real DEFAULT_DEFAULT_HEIGHT;
			static const Ogre::Real DEFAULT_DEFAULT_DEPTH;
	        ...
	        */
			...
			/** 
	        */
			inline size_t getVisualParticleQuota(void) const;
			void setVisualParticleQuota(size_t quota);

			/** 
	        */
			inline size_t getEmittedEmitterQuota(void) const;
			void setEmittedEmitterQuota(size_t quota);

			/** 
	        */
			inline size_t getEmittedTechniqueQuota(void) const;
			void setEmittedTechniqueQuota(size_t quota);

			/** 
	        */
			inline size_t getEmittedAffectorQuota(void) const;
	        ...
	        */
			...
			/** 
	        */
			inline const Ogre::Real getDefaultWidth(void) const;
			void setDefaultWidth(const Ogre::Real width);

			/** 
	        */
			inline const Ogre::Real getDefaultHeight(void) const;
			void setDefaultHeight(const Ogre::Real height);

			/** 
	        */
			inline const Ogre::Real getDefaultDepth(void) const;
	        ...
	        */
			inline Ogre::Real getCameraSquareDistance(void) const {return mCameraSquareDistance;};
	        ...
	        */
			inline size_t getNumEmitters (void) const;
	        ...
	        */
			...
			@remarks
				...
				marked for emission.
	        */
			inline size_t getNumEmittedEmitters (void) const;
	        ...
	        */
			inline size_t getNumAffectors (void) const;
	        ...
	        */
			...
			@remarks
				...
				marked for emission.
	        */
			inline size_t getNumEmittedAffectors (void) const;
	        ...
	        */
			inline size_t getNumObservers (void) const;
	        ...
	        */
			inline size_t getNumExterns (void) const;
			...
			*/
			inline bool _isExpired(Particle* particle, Ogre::Real timeElapsed);
			...
			*/
			inline const Ogre::AxisAlignedBox& getWorldBoundingBox(void) const {return mWorldAABB;}
		...
		protected:
			...
			*/
			void _processRenderer(Particle* particle, Ogre::Real timeElapsed, bool firstParticle);
			...
			*/
			inline void _processParticleSelf(Particle* particle, Ogre::Real timeElapsed, bool firstParticle);
			...
			*/
			inline void _processMotion(Particle* particle, Ogre::Real timeElapsed, bool firstParticle);
