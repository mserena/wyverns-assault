		...
		*/
		class _ParticleUniverseExport PhysXExtern : public PhysicsExtern
		{
			public:
				...
				*/
				virtual void synchronize(Ogre::Real timeElapsed) = 0;

				/** Get the collision group.
				*/
				virtual Ogre::uint16 getCollisionGroup(void) const
				{
				...
				*/
				virtual void setCollisionGroup(Ogre::uint16 collisionGroup)
				{
