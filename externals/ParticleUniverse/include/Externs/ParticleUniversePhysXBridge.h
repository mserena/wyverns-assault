...
#include "ParticleUniversePrerequisites.h"
	...
	namespace ParticleUniverse
	{
		...
		// Constants
		static const Ogre::Real SIMULATION_INTERVAL = 0.02f;
		...
		*/
		class _ParticleUniverseExport PhysXBridge : public Ogre::Singleton<PhysXBridge>
		{
			public:
				PhysXBridge(void);
				...
				/** Initialise the PhysX engine. This is needed for test purposes, because it is usually done outside of the Particle
					Universe plugin.
				*/
				bool initNx(Ogre::Real gravityY = -100);
				...
				*/
				void createPlane(const Ogre::Vector3& normal = Ogre::Vector3::ZERO, Ogre::Real d = -200);

				/** Return the gravity of the PhysX scene.
				*/
				void getGravity(Ogre::Vector3& gravity);
				...
				*/
				bool isRegisteredCollisionGroup(Ogre::uint16 collisionGroup);
			...
			protected:
				...
				Ogre::vector<PhysXExtern*>::type mExternList;
				Ogre::Controller<Ogre::Real>* mTimeController; // Controller for simulation
				Ogre::Real mTimeSinceLastSimulation;
