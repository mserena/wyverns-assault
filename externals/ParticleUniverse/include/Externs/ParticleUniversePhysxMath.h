		...
		*/
		class _ParticleUniverseExport PhysXMath
		{
			public:
				...
				// Converters
				static inline Ogre::Vector3 convert(const NxVec3& nxVec3){ return Ogre::Vector3(nxVec3.x, nxVec3.y, nxVec3.z); }
				static inline NxVec3 convert(const Ogre::Vector3& vector3){ return NxVec3(vector3.x, vector3.y, vector3.z); }
				static inline Ogre::Quaternion convert(const NxQuat& q) {return Ogre::Quaternion(q.w, q.x, q.y, q.z); }
