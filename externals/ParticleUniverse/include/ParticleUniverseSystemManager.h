...
namespace ParticleUniverse
{
	...
	class _ParticleUniverseExport DepthMapTargetListener : public Ogre::RenderTargetListener, public Ogre::RenderQueue::RenderableListener
	{
		public: 
			...
			Ogre::vector<ParticleRenderer*>::type mRenderers;
	};
	...
	*/
	class _ParticleUniverseExport ParticleSystemManager:
		public Ogre::Singleton<ParticleSystemManager>, public ScriptWriter
    {
		...
		protected:
	        ...
	        */
			...
			// Emitter Factories
			typedef Ogre::map<Ogre::String, ParticleEmitterFactory*>::type EmitterFactoryMap;
			EmitterFactoryMap mEmitterFactories;

			// Affector Factories
			typedef Ogre::map<Ogre::String, ParticleAffectorFactory*>::type AffectorFactoryMap;
			AffectorFactoryMap mAffectorFactories;

			// Observer Factories
			typedef Ogre::map<Ogre::String, ParticleObserverFactory*>::type ObserverFactoryMap;
			ObserverFactoryMap mObserverFactories;

			// EventHandler Factories
			typedef Ogre::map<Ogre::String, ParticleEventHandlerFactory*>::type EventHandlerFactoryMap;
			EventHandlerFactoryMap mEventHandlerFactories;

			// Renderer Factories
			typedef Ogre::map<Ogre::String, ParticleRendererFactory*>::type RendererFactoryMap;
			RendererFactoryMap mRendererFactories;

			// Extern Factories
			typedef Ogre::map<Ogre::String, ExternFactory*>::type ExternFactoryMap;
			ExternFactoryMap mExternFactories;

			// Behaviour Factories
			typedef Ogre::map<Ogre::String, ParticleBehaviourFactory*>::type BehaviourFactoryMap;
			...
			*/
			typedef Ogre::map<Ogre::String, IAlias*>::type AliasMap;
			AliasMap mAliasMap;
			...
			*/
			...
			Ogre::String mDepthTextureName;
			Ogre::String mDepthMaterialName;
			Ogre::String mDepthVertexName;
			Ogre::String mDepthFragmentName;
			Ogre::RenderTexture* mDepthMap;
			Ogre::Technique* mDepthTechnique;
			...
			Ogre::Real mDepthScale;

			// Name of the last created template.
			Ogre::String mLastCreatedParticleSystemTemplateName;
		...
		public:
			...
			*/
			ParticleEmitterFactory* getEmitterFactory(const Ogre::String& emitterType);

			/** Remove an ParticleEmitterFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeEmitterFactory(const Ogre::String& emitterType);
			...
			*/
			ParticleAffectorFactory* getAffectorFactory(const Ogre::String& affectorType);

			/** Remove an ParticleAffectorFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeAffectorFactory(const Ogre::String& affectorType);
			...
			*/
			ParticleObserverFactory* getObserverFactory(const Ogre::String& observerType);

			/** Remove an ParticleObserverFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeObserverFactory(const Ogre::String& affectorType);

			/** Delete a ParticleObserverFactory given its type.
	        */
			void destroyObserverFactory(const Ogre::String& observerType);
			...
			*/
			ParticleEventHandlerFactory* getEventHandlerFactory(const Ogre::String& eventHandlerType);

			/** Remove an ParticleEventHandlerFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeEventHandlerFactory(const Ogre::String& affectorType);

			/** Delete a ParticleEventHandlerFactory given a certain type.
	        */
			void destroyEventHandlerFactory(const Ogre::String& eventHandlerType);
			...
			*/
			ParticleRendererFactory* getRendererFactory(const Ogre::String& rendererType);

			/** Remove an ParticleRendererFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeRendererFactory(const Ogre::String& affectorType);
			...
			*/
			ExternFactory* getExternFactory(const Ogre::String& externType);

			/** Remove an ParticleExternFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeExternFactory(const Ogre::String& affectorType);
	        ...
	        */
			ParticleBehaviourFactory* getBehaviourFactory(const Ogre::String& behaviourType);

			/** Remove an ParticleBehaviourFactory, but doesn't delete it. Search the factory by its type.
			*/
			void removeBehaviourFactory(const Ogre::String& affectorType);
	        ...
	        */
			void replaceParticleSystemTemplate(const Ogre::String& name, ParticleSystem* system);
	        ...
	        */
			const Ogre::String& getLastCreatedParticleSystemTemplateName(void);
			...
			*/
			void destroyParticleSystemTemplate(const Ogre::String& templateName);

			/** Fill a list of template names in the vector.
			*/
			void particleSystemTemplateNames(Ogre::vector<Ogre::String>::type& v);
	        ...
	        */
			ParticleSystem* getParticleSystem(const Ogre::String& name);
			...
			*/
			void writeScript(ParticleSystem* particleSystem, const Ogre::String& fileName);

			/** Writes a ParticleSystem to string in the script format.
			*/
			const Ogre::String& writeScript(ParticleSystem* particleSystem);
	        ...
	        */
			void createDepthMap (Ogre::Camera* camera, Ogre::SceneManager* sceneManager);
	        ...
	        */
			bool notifyDepthMapNeeded(Ogre::Camera* camera, Ogre::SceneManager* sceneManager);
	        ...
	        */
			Ogre::Real getDepthScale(void) const;
			void setDepthScale(Ogre::Real depthScale);

			/** Returns the name of the depth texture.
	        */
			const Ogre::String& getDepthTextureName (void);
	        ...
	        */
			void setExternDepthTextureName (const Ogre::String& depthTextureName);
