	...
	class _ParticleUniverseExport BoxSet : public PrimitiveShapeSet
	{
		protected:
			...
			*/
			...
			typedef Ogre::list<Box*>::type ActiveBoxList;
			typedef Ogre::list<Box*>::type FreeBoxList;
			typedef Ogre::vector<Box*>::type BoxPool;
		...
		public:
			...
			*/
			void setDefaultDimensions(Ogre::Real width, Ogre::Real height, Ogre::Real depth);

			/** See setDefaultDimensions - this sets 1 component individually.
			*/
			void setDefaultWidth(Ogre::Real width);

			/** See setDefaultDimensions - this gets 1 component individually.
			*/
			Ogre::Real getDefaultWidth(void) const;

			/** See setDefaultDimensions - this sets 1 component individually.
			*/
        	void setDefaultHeight(Ogre::Real height);

			/** See setDefaultDimensions - this gets 1 component individually.
			*/
			Ogre::Real getDefaultHeight(void) const;

			/**  See setDefaultDimensions - this gets 1 component individually.
			*/
        	void setDefaultDepth(Ogre::Real depth);

			/** See setDefaultDimensions - this gets 1 component individually.
			*/
			Ogre::Real getDefaultDepth(void) const;
