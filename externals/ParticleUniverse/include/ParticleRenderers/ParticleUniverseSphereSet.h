	...
	class _ParticleUniverseExport SphereSet : public PrimitiveShapeSet
	{
		protected:
			...
			*/
			...
			typedef Ogre::list<Sphere*>::type ActiveSphereList;
			typedef Ogre::list<Sphere*>::type FreeSphereList;
			typedef Ogre::vector<Sphere*>::type SpherePool;
		...
		public:
			...
			*/
			void setDefaultRadius(Ogre::Real radius);

			/** See setDefaultRadius
			*/
			Ogre::Real getDefaultRadius(void) const;
