	...
	*/
	class _ParticleUniverseExport ParticleObserver : public IAlias, public IElement
	{
		public:
			...
			static const Ogre::Real DEFAULT_INTERVAL;
			static const bool DEFAULT_UNTIL_EVENT;

			typedef Ogre::vector<ParticleEventHandler*>::type::iterator ParticleEventHandlerIterator;
			typedef Ogre::vector<ParticleEventHandler*>::type::const_iterator ParticleEventHandlerConstIterator;
			typedef Ogre::vector<ParticleEventHandler*>::type ParticleEventHandlerList;
