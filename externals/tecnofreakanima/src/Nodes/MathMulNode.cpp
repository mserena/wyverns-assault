...
IPort* MathMulNode::getAPort()
{
	return m_aPort;
}

const IPort* MathMulNode::getAPort() const
{
	return m_aPort;
}

IPort* MathMulNode::getBPort()
{
	return m_bPort;
}

const IPort* MathMulNode::getBPort() const
{
	return m_bPort;
}

float MathMulNode::evaluateValue()
{
