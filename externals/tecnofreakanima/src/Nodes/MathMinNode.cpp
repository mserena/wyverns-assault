...
IPort* MathMinNode::getAPort()
{
	return m_aPort;
}

const IPort* MathMinNode::getAPort() const
{
	return m_aPort;
}

IPort* MathMinNode::getBPort()
{
	return m_bPort;
}

const IPort* MathMinNode::getBPort() const
{
	return m_bPort;
}

float MathMinNode::evaluateValue()
{
