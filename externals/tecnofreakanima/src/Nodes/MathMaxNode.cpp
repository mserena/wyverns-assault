...
IPort* MathMaxNode::getAPort()
{
	return m_aPort;
}

const IPort* MathMaxNode::getAPort() const
{
	return m_aPort;
}

IPort* MathMaxNode::getBPort()
{
	return m_bPort;
}

const IPort* MathMaxNode::getBPort() const
{
	return m_bPort;
}

float MathMaxNode::evaluateValue()
{
