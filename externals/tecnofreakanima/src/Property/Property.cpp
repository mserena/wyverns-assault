...
int Property::getValueAsInteger() const
{
	...
	if ( failed )
	{
		throw std::exception( "Failed to convert value to integer." );
	}
...
float Property::getValueAsFloat() const
{
	...
	if ( failed )
	{
		throw std::exception( "Failed to convert value to float." );
	}
...
bool Property::getValueAsBoolean() const
{
	...
	std::transform( valueString.begin(), valueString.end(), valueString.begin(), std::tolower );
	...
	{
		throw std::exception( "Failed to convert value to boolean." );
	}
}