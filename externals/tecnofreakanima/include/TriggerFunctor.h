...
*/
template < typename T >
class TecnoFreakDllExport TriggerFunctor
	: public ITriggerSubscriber
{
public:
	TriggerFunctor( T* object, void( __thiscall T::*memberFunction )( const ITrigger* ) )
		: m_object( object )
...
private:
	void ( __thiscall T::*m_memberFunction )( const ITrigger* );
	T* m_object;
