...
// This means that a node cannot have two outputs that operate in a different way.
...
public:
	...
	virtual const std::string& getName() const = 0;
		...
		@param elapsedSeconds Seconds that have gone by since last tree traversal. 
		...
		*/
	virtual void evaluateAnimations( const float weight, AnimationNodeList& reachedAnimationNodes ) = 0;
